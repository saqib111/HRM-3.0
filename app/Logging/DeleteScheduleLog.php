...
class DeleteScheduleLog
{
  ...
  {
    $basePath = base_path('laravel_logs/Delete_Schedule');
    if (!File::exists($basePath)) {
      File::makeDirectory($basePath, 0755, true);
    }

    // Define the path of the log file
    $logPath = $basePath . '/delete_schedule_data.txt'; // Directly creating update_employees.txt
    ...
    $logger = new Logger('delete_schedule_log');
