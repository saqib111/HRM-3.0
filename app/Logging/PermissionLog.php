...
class PermissionLog
{
  ...
  {
    $basePath = base_path('laravel_logs/Permissions');
    if (!File::exists($basePath)) {
      File::makeDirectory($basePath, 0755, true);
    }

    // Define the path of the log file
    $logPath = $basePath . '/permissions_data.txt'; // Directly creating update_employees.txt
    ...
    $logger = new Logger('permission_log');
