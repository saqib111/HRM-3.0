  ...
  $(document).ready(function () {
    const table = $('#leave_balance_table').DataTable({
      ...
      columns: [{
        ...
        orderable: false,
        searchable: false,
        className: 'text-center' // Center alignment for this column
      },
      {
        data: 'username',
        name: 'username'
      ...
      },
      {
        ...
        render: function (data, type, row) {
          return `
            <button class="btn btn-primary" onclick="editLeaveBalance(${row.id})"><i class="fa fa-edit"></i></button>
          `;
        },
        orderable: false,
        searchable: false,
