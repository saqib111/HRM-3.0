        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="main-employee-title">
                    <h3 class="page-title"><span data-translate="late_employee_attendance">Late Employee Attendance</span>
                    </h3>
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><span data-translate="late_employee_attendance">Late Employee
                            Attendance</span></li>
                </ul>
            </div>
        </div>
                ...
                <table class="table  custom-table mb-0" id="late-employees-table">
                    <thead>
                        <tr class="table_row">
                            ...
                            <th class="text-center"><span data-translate="verify_two">Verify</span></th>
                        </tr>
                    </thead>
                    <tbody>
