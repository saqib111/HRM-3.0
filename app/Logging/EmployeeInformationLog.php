...
class EmployeeInformationLog
{
  ...
  {
    $basePath = base_path('laravel_logs/EmployeeInfo');
    if (!File::exists($basePath)) {
      File::makeDirectory($basePath, 0755, true);
    }

    // Define the path of the log file
    $logPath = $basePath . '/employee_info_data.txt'; // Directly creating update_employees.txt
    ...
    $logger = new Logger('employee_info_log');
