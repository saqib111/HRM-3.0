...
class PayrollController extends Controller
{
    ...
    //                 LEAST(
    //                     4.0, -- Maximum fine for late check-in and early check-out combined for a single day
    //                     GREATEST(
    //                         CEIL(TIMESTAMPDIFF(MINUTE, attendance_records.shift_in, attendance_records.check_in) / 15) * 0.125, 0
    //                     ) +
    //                     GREATEST(
    //                         CEIL(TIMESTAMPDIFF(MINUTE, attendance_records.check_out, attendance_records.shift_out) / 15) * 0.125, 0
    //                     )
    //                 )
    //             ELSE 0 
    //         END
