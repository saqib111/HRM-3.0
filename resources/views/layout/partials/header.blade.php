          ...
          <ul class="notification-list">
                ...
                <div class="chat-block d-flex">
                  ...
                  <div class="media-body flex-grow-1">
                    <p class="noti-details"><span class="noti-title">Misty Tison</span> added
                      <span class="noti-title">Domenic Houston</span> and <span class="noti-title">Claire Mapes</span>
            ...
            <li class="notification-message">
              <a href="{{ url('activities') }}">
                <div class="chat-block d-flex">
                  <span class="avatar flex-shrink-0">
                    <img src="{{ URL::asset('/assets/img/profiles/avatar-17.jpg') }}" alt="User Image">
                  </span>
                  <div class="media-body flex-grow-1">
