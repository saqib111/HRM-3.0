...
@section('content')
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-4">
                <h3 class="page-title"><span data-translate="balance">Leave Balance</span></h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a
                            href="{{ auth()->user()->role == '1' ? url('admin-dashboard') : url('attendance-employee') }}">Dashboard</a>
                    </li>
                    <li class="breadcrumb-item active"><span data-translate="=balance">Leave Balance</span></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <table class="table table-striped custom-table" id="leave_balance_table">
                    <thead>
                        <tr>
                            ...
                            <th><span data-translate="username">Name</span></th>
                            <th class="text-center"><span data-translate="leave_type">Leave Type</span></th>
                            <th class="text-center"><span data-translate="balance">Leave Balance</span></th>
                            <th class="text-center"><span data-translate="last_year_balance">Leave Year Balance</span></th>
