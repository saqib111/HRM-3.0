...
<div class="page-header">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('user.settings') }}">Settings</a></li>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-6 d-flex flex-column align-items-center justify-content-center border-end">
                ...
                <form action="{{ route('settings.updateImage') }}" method="POST" id="imageForm"
                    ...
                    <button type="submit" class="btn btn-primary mt-3" id="updateButton" style="display: none;">Update
                        Image</button>
                </form>
            </div>
            ...
            <div class="col-md-6 p-4">
                <h5 class="card-title mb-5">Update Password</h5>
                <form id="passwordForm">
                    ...
                    <button type="submit" class="btn btn-success" id="submitButton">Update Password</button>
