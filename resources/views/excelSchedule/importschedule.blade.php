...
@section('content')
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-4">
                <h3 class="page-title"><span data-translate="upload_schedule">Upload Schedule</span></h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a
                            href="{{ auth()->user()->role == '1' ? url('admin-dashboard') : url('attendance-employee') }}">Dashboard</a>
                    </li>
                    <li class="breadcrumb-item active"><span data-translate="upload_schedule">Upload Schedule</span></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="mb-4">
                    <p class="card-text text-muted">
                        <strong><span data-translate="note">Note:</span></strong>
                    <ul class="list-unstyled mt-3">
                        <li><i class="fa-solid fa-check-circle text-success"></i><span data-translate="schedule_note_one"
                                class="ms-1"></span></li>
                        <li class="mt-2"><i class="fa-solid fa-check-circle text-success"></i><span
                                data-translate="schedule_note_two" class="ms-1"></span></li>
                        <li class="mt-2"><i class="fa-solid fa-check-circle text-success"></i><span
                                data-translate="schedule_note_three" class="ms-1"></span></li>
                    </ul>
                    </p>
                </div>
                <div class="d-flex justify-content-end mb-2">
                    <a class="btn btn-primary px-4 py-2" href="{{ asset('files/demo_attendance.xlsx') }}">
                        <i class="fa-solid fa-download me-2"></i><span data-translate="download_demo_file">Download Demo
                            File</span>
                    </a>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        <div class="container1">
                            ...
                            <label for="file" id="chosefile" class="custom-file-upload mb-2">
                                <i class="fa-solid fa-folder-open me-2"></i> <span data-translate="choose_file">Choose
                                    File</span>
                            </label>
                            ...
                            <div id="submit-dv" class="hidden mt-5">
                                <button type="submit" id="submit" class="custom-file-upload">
                                    <i class="fa-solid fa-upload"></i> <span data-translate="upload_file">Upload File</span>
                                </button>
