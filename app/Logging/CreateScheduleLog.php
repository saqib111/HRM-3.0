...
class CreateScheduleLog
{
  ...
  {
    $basePath = base_path('laravel_logs/Create_Schedule');
    if (!File::exists($basePath)) {
      File::makeDirectory($basePath, 0755, true);
    }

    // Define the path of the log file
    $logPath = $basePath . '/create_schedule_data.txt'; // Directly creating update_employees.txt
    ...
    $logger = new Logger('create_schedule_log');
